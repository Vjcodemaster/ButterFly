...
public class PermissionHandler {
    ...
    public static String[] APP_PERMISSION = {Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_EXTERNAL_STORAGE};
    ...
    private void showPermissionExplanation(String sMSG, final int nPermissionFlag) {
        ...
        alertPermission.setMessage("To assist you better, ButterFly requires" + sMSG+"permission. Would you like to grant these permissions?")
