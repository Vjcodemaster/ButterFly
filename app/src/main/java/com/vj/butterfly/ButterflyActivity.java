...
public class ButterflyActivity extends AppCompatActivity {
    ...
    TextView tvNickName, tvThinkAbout, tvPhone;
    CircleImageView civProfilePreview;
    CardView cv;
    Toolbar toolbar;
    TextView tvTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sThink = bundle.getString("think");
        String sUserPhone = bundle.getString("phone");
        ...
        tvThinkAbout.setText(sThink);
        tvPhone.setText(sUserPhone);
        toolbar.getNavigationIcon().setColorFilter(getResources().getColor(R.color.colorNextToWhite), PorterDuff.Mode.SRC_ATOP);
        shortAnimationDuration = getResources().getInteger(android.R.integer.config_shortAnimTime);
    }

    private void initViews() {
        tvNickName = findViewById(R.id.tv_nick_name);
        tvThinkAbout = findViewById(R.id.tv_thinking_about);
        tvPhone = findViewById(R.id.tv_phone_number);
        toolbar = findViewById(R.id.toolbar);
        tvTitle = toolbar.findViewById(R.id.tv_title);

        tvTapToClose = findViewById(R.id.tv_tap_to_close);
        civProfilePreview = findViewById(R.id.civ_profile_preview);
        frameLayout = findViewById(R.id.container);
        cv = findViewById(R.id.cv);

        civProfilePreview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomImageFromThumb(civProfilePreview, R.drawable.vj);
